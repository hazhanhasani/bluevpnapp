...
class WarpAdaptive467Tests(unittest.TestCase):
    def test_version_is_fixed_467(self):
        self.assertEqual(RELEASE['version'], '4.6.7')
        self.assertEqual(RELEASE['version_code'], 40607)
