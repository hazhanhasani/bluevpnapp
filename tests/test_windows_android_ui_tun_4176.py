...
class WindowsAndroidUiTun4176Tests(unittest.TestCase):
    ...
    def test_windows_home_matches_android_surface_order(self):
        ...
        tokens=['SubscriptionSummaryText','StatusText','OrbHalo','ConnectButton','UploadSpeedValue','DurationValue','DownloadSpeedValue','AdCard','EndpointText','RemainingVolumeValue','RemainingTimeValue','AccountDrawer','MenuDrawer']
        last=-1
    ...
    def test_v2rayn_split_core_tun_is_real_system_path(self):
        ...
        self.assertIn('ResolveSingBox',ctrl)
