...
class WarpAdaptive469Tests(unittest.TestCase):
    def test_version_is_fixed_469(self):
        self.assertEqual(RELEASE['version'], '4.6.9')
        self.assertEqual(RELEASE['version_code'], 40609)
