...
final class BlueVPN_Cron {
    ...
    public static function schedules(array $s): array { $s['bluevpn_one_minute']=['interval'=>60,'display'=>'BlueVPN every minute']; $s['bluevpn_five_minutes']=['interval'=>300,'display'=>'BlueVPN every 5 minutes']; return $s; }
    ...
    public static function cleanup(): void {
        ...
        $otp=BlueVPN_DB::table('otp_challenges');
        $live=BlueVPN_DB::table('ai_live_connections');
