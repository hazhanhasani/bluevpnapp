...
class WindowsAiSpeedAuth508Tests(unittest.TestCase):
    def test_release_is_508(self):
        ...
        self.assertEqual(r['version'],'6.2.10')
        self.assertEqual(r['version_code'],60210)
    ...
    def test_connection_path_is_bounded_and_parallel(self):
        ...
        self.assertIn('int timeoutSeconds = 9',verifier)
        self.assertIn('TimeSpan.FromSeconds(Math.Clamp(timeoutSeconds, 3, 12))',verifier)
        self.assertIn('XrayConfigBuilder.LocalHttpPort,\n            ct,\n            4)',o)
