...
def test_release_is_502_and_codes_match():
    ...
    assert rel['version']=='6.0.1' and rel['version_code']==60001
    assert app['version_name']=='6.0.1' and app['version_code']==60001
    assert rel['windows_version']=='6.0.1' and rel['windows_version_code']==60001
