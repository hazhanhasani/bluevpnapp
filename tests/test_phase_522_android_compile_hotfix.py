...
class AndroidCompileHotfix522Tests(unittest.TestCase):
    def test_release_is_522(self):
        ...
        self.assertEqual(r["version"], "5.4.8")
        self.assertEqual(r["version_code"], 50408)
        self.assertEqual(r["android_version"], "5.4.8")
        self.assertEqual(r["android_version_code"], 50408)
