...
final class BlueVPN_DB {
    ...
    public static function install_schema(): void {
        ...
        $queries[] = "CREATE TABLE {$t('pasarguard_panels')} (
            ...
            api_contract varchar(40) NOT NULL DEFAULT '',
        ...
        $queries[] = "CREATE TABLE {$t('gateway_nodes')} (
            ...
            max_sessions int NOT NULL DEFAULT 5000,
            draining tinyint(1) NOT NULL DEFAULT 0,
            secret_enc longtext NULL,
            secret_hash varchar(64) NOT NULL DEFAULT '',
            previous_secret_enc longtext NULL,
            previous_secret_hash varchar(64) NOT NULL DEFAULT '',
            previous_secret_expires_at datetime NULL,
            secret_generation bigint unsigned NOT NULL DEFAULT 1,
            last_secret_rotated_at datetime NULL,
            enrollment_token_hash varchar(64) NOT NULL DEFAULT '',
            ...
            updated_at datetime NULL,
            PRIMARY KEY  (id),
            KEY ix_gateway_node_active (active, draining, health_status, last_seen_at),
            KEY ix_gateway_node_capacity (active, max_sessions, active_sessions)
        ) $cc;";
        ...
        $queries[] = "CREATE TABLE {$t('gateway_sessions')} (
            ...
            agent_epoch varchar(64) NOT NULL DEFAULT '',
            ...
            KEY ix_gateway_session_node (node_id, status, role)
        ) $cc;";
        ...
        $queries[] = "CREATE TABLE {$t('plans')} (
            ...
            usd_price decimal(14,6) NULL DEFAULT NULL,
            usd_managed tinyint(1) NOT NULL DEFAULT 0,
            usd_last_price_toman bigint NOT NULL DEFAULT 0,
            usd_updated_at datetime NULL,
        ...
        $queries[] = "CREATE TABLE {$t('free_reward_claims')} (
            id bigint unsigned NOT NULL AUTO_INCREMENT,
            event_id varchar(64) NOT NULL,
            customer_id bigint unsigned NULL,
            device_id varchar(180) NOT NULL DEFAULT '',
            placement varchar(40) NOT NULL DEFAULT 'rewarded_video',
            granted_minutes int NOT NULL DEFAULT 0,
            app_version varchar(40) NOT NULL DEFAULT '',
            created_at datetime NULL,
            PRIMARY KEY  (id),
            UNIQUE KEY uq_free_reward_event (event_id),
            KEY ix_free_reward_customer (customer_id, created_at),
            KEY ix_free_reward_device (device_id, created_at),
            KEY ix_free_reward_placement (placement, created_at)
        ) $cc;";
        ...
        $queries[] = "CREATE TABLE {$t('sms_deliveries')} (
            ...
            customer_id bigint unsigned NULL,
            manual_customer_id bigint unsigned NULL,
            order_id varchar(36) NULL,
            phone varchar(20) NOT NULL DEFAULT '',
            ...
            KEY ix_sms_manual_customer (manual_customer_id, created_at),
    ...
    public static function default_settings(): array {
        return [
            ...
            'tapsell_app_id' => '',
            'tapsell_app_key' => '',
            // Legacy single-zone key retained for older Android clients.
            'tapsell_interstitial_zone_id' => '',
            'tapsell_rewarded_video_zone_id' => '',
            'tapsell_interstitial_video_zone_id' => '',
            'tapsell_pre_roll_video_zone_id' => '',
            'tapsell_native_video_zone_id' => '',
            'tapsell_standard_banner_zone_id' => '',
            'tapsell_interstitial_banner_zone_id' => '',
            'tapsell_native_banner_zone_id' => '',
            'tapsell_show_after_connect' => true,
            'tapsell_min_interval_seconds' => 0,
            'tapsell_daily_cap' => 0,
            'tapsell_rewarded_bonus_minutes' => 15,
            'tapsell_reward_fullscreen_suppression_seconds' => 300,
            'tapsell_standard_banner_size' => 'BANNER_320_50',
            'tapsell_standard_banner_every_slides' => 3,
            ...
            'tapsell_windows_web_height' => 146,
            'tapsell_windows_web_rewarded_video_placement_id' => '',
            'tapsell_windows_web_rewarded_video_enabled' => false,
            'tapsell_windows_web_rewarded_video_min_interval_seconds' => 300,
            'tapsell_windows_web_rewarded_video_daily_cap' => 5,
            'tapsell_windows_web_interstitial_video_placement_id' => '',
            'tapsell_windows_web_interstitial_video_enabled' => false,
            'tapsell_windows_web_interstitial_video_min_interval_seconds' => 1200,
            'tapsell_windows_web_interstitial_video_daily_cap' => 3,
            'tapsell_windows_web_pre_roll_video_placement_id' => '',
            'tapsell_windows_web_pre_roll_video_enabled' => false,
            'tapsell_windows_web_pre_roll_video_min_interval_seconds' => 1800,
            'tapsell_windows_web_pre_roll_video_daily_cap' => 2,
            'tapsell_windows_web_native_video_placement_id' => '',
            'tapsell_windows_web_native_video_enabled' => false,
            'tapsell_windows_web_native_video_min_interval_seconds' => 900,
            'tapsell_windows_web_native_video_daily_cap' => 4,
            'tapsell_windows_web_standard_banner_placement_id' => '',
            'tapsell_windows_web_standard_banner_enabled' => true,
            'tapsell_windows_web_standard_banner_min_interval_seconds' => 120,
            'tapsell_windows_web_standard_banner_daily_cap' => 0,
            'tapsell_windows_web_interstitial_banner_placement_id' => '',
            'tapsell_windows_web_interstitial_banner_enabled' => false,
            'tapsell_windows_web_interstitial_banner_min_interval_seconds' => 1200,
            'tapsell_windows_web_interstitial_banner_daily_cap' => 3,
            'tapsell_windows_web_native_banner_placement_id' => '',
            'tapsell_windows_web_native_banner_enabled' => false,
            'tapsell_windows_web_native_banner_min_interval_seconds' => 600,
            'tapsell_windows_web_native_banner_daily_cap' => 6,
            'tapsell_rewarded_video_enabled' => true,
            'tapsell_rewarded_video_min_interval_seconds' => 300,
            'tapsell_rewarded_video_daily_cap' => 5,
            'tapsell_interstitial_video_enabled' => true,
            'tapsell_interstitial_video_min_interval_seconds' => 1200,
            'tapsell_interstitial_video_daily_cap' => 3,
            'tapsell_pre_roll_video_enabled' => true,
            'tapsell_pre_roll_video_min_interval_seconds' => 1800,
            'tapsell_pre_roll_video_daily_cap' => 2,
            'tapsell_native_video_enabled' => true,
            'tapsell_native_video_min_interval_seconds' => 900,
            'tapsell_native_video_daily_cap' => 4,
            'tapsell_standard_banner_enabled' => true,
            'tapsell_standard_banner_min_interval_seconds' => 120,
            'tapsell_standard_banner_daily_cap' => 0,
            'tapsell_interstitial_banner_enabled' => true,
            'tapsell_interstitial_banner_min_interval_seconds' => 1200,
            'tapsell_interstitial_banner_daily_cap' => 3,
            'tapsell_native_banner_enabled' => true,
            'tapsell_native_banner_min_interval_seconds' => 600,
            'tapsell_native_banner_daily_cap' => 6,
            ...
            'free_warp_enabled' => true,
            'free_warp_mode' => 'warp_fallback_pool',
            'free_warp_fallback_enabled' => true,
            'free_warp_start_timeout_seconds' => 30,
            'free_warp_schema' => 2,
            'free_warp_adaptive_enabled' => true,
            'free_warp_endpoint_racing_enabled' => true,
            'free_warp_endpoint_race_breadth' => 8,
            'free_warp_endpoint_probe_seconds' => 5,
            ...
            'free_warp_fragment_delay' => '5-15',
            'free_warp_wireguard_enabled' => true,
            'free_warp_gool_enabled' => false,
            'free_warp_warm_timeout_seconds' => 8,
            'free_warp_cold_timeout_seconds' => 30,
