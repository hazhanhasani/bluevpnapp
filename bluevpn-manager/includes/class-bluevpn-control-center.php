...
final class BlueVPN_Control_Center {
    ...
    public static function repair_missing_provider_subscriptions(): void {
        ...
        $summary=get_transient($key);if(!is_array($summary))$summary=['total'=>BlueVPN_Providers::repairable_customer_count(),'processed'=>0,'created'=>0,'attached'=>0,'existing'=>0,'resynced'=>0,'skipped'=>0,'error_count'=>0,'errors'=>[],'seen'=>[],'started_at'=>BlueVPN_Utils::tehran_datetime_fa()];
        ...
        if(empty($seen[(string)$id])){
            ...
            $summary['created']+=(int)($r['created']??0);$summary['attached']+=(int)($r['attached']??0);$summary['existing']+=(int)($r['existing']??0);$summary['resynced']+=(int)($r['resynced']??0);
