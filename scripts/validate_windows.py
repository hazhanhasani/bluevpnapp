...
def main() -> None:
    ...
    require(version == "5.1.9", "this Windows migration must be release 5.1.9")
    ...
    # 5.1.9 Windows stability gates: Android UI parity, non-blocking media/metrics,
    ...
    # 5.1.9 CI/release hardening: installers must be root-level artifacts and
