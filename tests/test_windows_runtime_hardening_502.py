...
def test_release_is_502_and_codes_match():
    ...
    assert rel['version']=='5.2.0' and rel['version_code']==50200
    assert app['version_name']=='5.2.0' and app['version_code']==50200
    assert rel['windows_version']=='5.2.0' and rel['windows_version_code']==50200
