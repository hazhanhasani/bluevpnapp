...
def test_release_is_502_and_codes_match():
    ...
    assert rel['version']=='5.5.7' and rel['version_code']==50507
    assert app['version_name']=='5.5.7' and app['version_code']==50507
    assert rel['windows_version']=='5.5.7' and rel['windows_version_code']==50507
