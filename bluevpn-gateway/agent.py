#!/usr/bin/env python3
"""BlueVPN first-party gateway agent — Phase 3 HA + resilient metering.
...
class Agent:
    def __init__(self, cfg: dict[str, Any]):
        self.cfg=cfg; self.base=str(cfg["manager_url"]).rstrip("/"); self.node_id=int(cfg["node_id"]); self.secret=str(cfg["node_secret"])
