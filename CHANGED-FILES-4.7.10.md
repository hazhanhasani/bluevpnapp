...
- `branding/app.json` — 4.10.0 / 41000.
- `release.json` — 4.10.0 Fast CI release metadata.
- `bluevpn-manager/bluevpn-manager.php` — synchronized 4.10.0 version.
- `bluevpn-manager/readme.txt` — synchronized 4.10.0 changelog.
...
- `tests/test_sms_otp_autofill_477.py` / `tests/test_warp_adaptive_469.py` — current version contract updated to 4.10.0.
