...
def test_release_368():
    ...
    assert r['version']=='3.0.75'
    assert r['version_code']==30075
    assert r['android_version']=='3.0.75'
    assert r['android_version_code']==30075
    assert a['version_name']=='3.0.75'
    assert a['version_code']==30075
