...
def test_release_368():
    ...
    assert r['version']=='3.0.78'
    assert r['version_code']==30078
    assert r['android_version']=='3.0.78'
    assert r['android_version_code']==30078
    assert a['version_name']=='3.0.78'
    assert a['version_code']==30078
