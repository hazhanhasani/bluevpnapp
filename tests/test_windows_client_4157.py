...
class WindowsClient4162Tests(unittest.TestCase):
    def test_release_versions_are_unified(self):
        ...
        self.assertEqual(release["version"], "4.16.8")
        self.assertEqual(release["windows_version"], "4.16.8")
        self.assertEqual(release["windows_version_code"], 41608)
        self.assertEqual(branding["version_name"], "4.16.8")
        self.assertIn("<Version>4.16.8</Version>", text("bluevpn-windows/BlueVPN.Windows.csproj"))
