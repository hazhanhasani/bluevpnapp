...
- `branding/app.json` — 4.11.1 / 41101.
- `release.json` — 4.11.1 Fast CI release metadata.
- `bluevpn-manager/bluevpn-manager.php` — synchronized 4.11.1 version.
- `bluevpn-manager/readme.txt` — synchronized 4.11.1 changelog.
...
- `tests/test_sms_otp_autofill_477.py` / `tests/test_warp_adaptive_469.py` — current version contract updated to 4.11.1.
