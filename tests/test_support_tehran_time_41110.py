...
class SupportTehranTime41110(unittest.TestCase):
    ...
    def test_release_version(self):
        ...
        self.assertEqual((release['version'], release['version_code']), ('4.12.1', 41201))
        self.assertEqual(app['version_source'], 'v4.12.1-runner-python-pregradle-fix')
        self.assertEqual(release['version_source'], 'v4.12.1-runner-python-pregradle-fix')
