...
class ManualCustomersCRM4151Tests(unittest.TestCase):
    ...
    def test_plugin_version_and_schema(self):
        ...
        self.assertIn("Version: 4.15.1", plugin)
        self.assertIn("BLUEVPN_MANAGER_SCHEMA_VERSION', '1.21.0'", plugin)
        self.assertEqual(release["version"], "4.15.1")
        self.assertEqual(branding["version_name"], "4.15.1")
        self.assertEqual(branding["version_code"], 41501)
