...
define('BLUEVPN_SITE_VERSION', '4.16.1');
...
// BlueVPN Site 4.16.1 cache/debug marker.
add_filter('body_class', static function($classes){ $classes[] = 'bluevpn-site-v4-16-0'; return $classes; });
