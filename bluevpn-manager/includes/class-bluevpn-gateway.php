...
final class BlueVPN_Gateway {
    ...
    private const ENROLLMENT_AGENT_MIN_VERSION = '5.2.2';
    ...
    /** Phase 4 / 5.2.2 safe staged rollout can be disabled instantly. */
    ...
    public static function render_admin_tab(): void {
        ...
        echo '<div class="bvc-page-tools"><div><h2 class="bvc-section-title">BlueVPN Gateway HA Metering</h2><p class="bvc-section-subtitle">Phase 6 / 5.2.2: Gateway Autopilot + نصب یک‌مرحله‌ای؛ Node و Secret و Agent به‌صورت خودکار Enrollment می‌شوند.</p></div><form method="post" action="'.esc_url(admin_url('admin-post.php')).'">';wp_nonce_field('bluevpn_cc_reconcile_gateways');echo '<input type="hidden" name="action" value="bluevpn_cc_reconcile_gateways"><button class="button button-primary">Reconcile همه Gatewayها</button></form></div>';
