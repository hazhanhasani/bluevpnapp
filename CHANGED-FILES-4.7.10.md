...
- `branding/app.json` — 4.11.6 / 41106.
- `release.json` — 4.11.6 Fast CI release metadata.
- `bluevpn-manager/bluevpn-manager.php` — synchronized 4.11.6 version.
- `bluevpn-manager/readme.txt` — synchronized 4.11.6 changelog.
...
- `tests/test_sms_otp_autofill_477.py` / `tests/test_warp_adaptive_469.py` — current version contract updated to 4.11.6.
