...
def main() -> None:
    ...
    require(version == "4.1.2" and code == 40102, "this hotfix source must be 4.1.2 / 40102")
    ...
    require("Version: 4.1.2" in manager, "WordPress plugin header version mismatch")
    require("BLUEVPN_MANAGER_VERSION', '4.1.2'" in manager, "WordPress plugin constant mismatch")
    require("BLUEVPN_MANAGER_SCHEMA_VERSION', '1.6.0'" in manager, "WordPress schema must be 1.6.0")
    require("Version: 4.1.2" in manager_readme and "Stable tag: 4.1.2" in manager_readme, "WordPress readme version/stable tag mismatch")
