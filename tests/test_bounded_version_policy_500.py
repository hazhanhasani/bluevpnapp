...
class BoundedVersionPolicy500Tests(unittest.TestCase):
    def test_all_canonical_components_are_500(self):
        ...
        self.assertEqual(release["version"], "6.0.1")
        self.assertEqual(release["version_code"], 60001)
        self.assertEqual(branding["version_name"], "6.0.1")
        self.assertEqual(branding["version_code"], 60001)
        self.assertEqual(release["android_version"], "6.0.1")
        self.assertEqual(release["android_version_code"], 60001)
        self.assertEqual(release["windows_version"], "6.0.1")
        self.assertEqual(release["windows_version_code"], 60001)
        self.assertEqual(release["manager_version"], "6.0.1")
        self.assertEqual(release["site_version"], "6.0.1")
        self.assertEqual(release["theme_version"], "6.0.1")
