...
def main() -> None:
    ...
    require(version == "5.2.4", "this Windows migration must be release 5.2.4")
    ...
    # 5.2.4 Windows stability gates: Android UI parity, non-blocking media/metrics,
    ...
    # 5.2.4 CI/release hardening: installers must be root-level artifacts and
