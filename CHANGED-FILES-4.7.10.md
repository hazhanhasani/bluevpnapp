...
- `branding/app.json` — 4.8.3 / 40803.
- `release.json` — 4.8.3 Fast CI release metadata.
- `bluevpn-manager/bluevpn-manager.php` — synchronized 4.8.3 version.
- `bluevpn-manager/readme.txt` — synchronized 4.8.3 changelog.
...
- `tests/test_sms_otp_autofill_477.py` / `tests/test_warp_adaptive_469.py` — current version contract updated to 4.8.3.
