...
class SessionLogoutPhpWindows4180Tests(unittest.TestCase):
    def test_release_version(self):
        ...
        self.assertEqual(r['version'],'5.10.10')
        self.assertEqual(r['version_code'],51010)
        self.assertEqual(b['version_name'],'5.10.10')
        self.assertEqual(b['version_code'],51010)
    ...
    def test_php_optional_warp_fields_never_read_unguarded(self):
        ...
        self.assertIn("$_POST['free_warp_ip_mode'] ?? 'v4'", ads)
