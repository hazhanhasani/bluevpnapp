...
required=['project.yml','BlueVPNApp/BlueVPNApp.swift','BlueVPNApp/HomeView.swift','BlueVPNApp/LocationsView.swift','BlueVPNApp/VPNManager.swift','BlueVPNApp/SecureSession.swift','PacketTunnel/PacketTunnelProvider.swift']
...
assert 'import SwiftyXrayKit' in tunnel and 'XrayBridge(packetFlow:packetFlow)' in tunnel
...
assert 'revision: 3c5405521ae547de110f6ea65df00b1c05f6a0bc' in project
