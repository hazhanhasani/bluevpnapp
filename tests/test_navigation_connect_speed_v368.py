...
def test_release_368():
    ...
    assert r['version']=='3.0.77'
    assert r['version_code']==30077
    assert r['android_version']=='3.0.77'
    assert r['android_version_code']==30077
    assert a['version_name']=='3.0.77'
    assert a['version_code']==30077
