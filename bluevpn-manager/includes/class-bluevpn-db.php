...
final class BlueVPN_DB {
    ...
    public static function default_settings(): array {
        return [
            ...
            'tapsell_reward_fullscreen_suppression_seconds' => 0,
            'tapsell_standard_banner_size' => 'BANNER_320_50',
            'tapsell_standard_banner_every_slides' => 1,
            'tapsell_rewarded_video_enabled' => true,
            'tapsell_rewarded_video_min_interval_seconds' => 0,
            'tapsell_rewarded_video_daily_cap' => 0,
            'tapsell_interstitial_video_enabled' => true,
            'tapsell_interstitial_video_min_interval_seconds' => 0,
            'tapsell_interstitial_video_daily_cap' => 0,
            'tapsell_pre_roll_video_enabled' => true,
            'tapsell_pre_roll_video_min_interval_seconds' => 0,
            'tapsell_pre_roll_video_daily_cap' => 0,
            'tapsell_native_video_enabled' => true,
            'tapsell_native_video_min_interval_seconds' => 0,
            'tapsell_native_video_daily_cap' => 0,
            'tapsell_standard_banner_enabled' => true,
            'tapsell_standard_banner_min_interval_seconds' => 0,
            'tapsell_standard_banner_daily_cap' => 0,
            'tapsell_interstitial_banner_enabled' => true,
            'tapsell_interstitial_banner_min_interval_seconds' => 0,
            'tapsell_interstitial_banner_daily_cap' => 0,
            'tapsell_native_banner_enabled' => true,
            'tapsell_native_banner_min_interval_seconds' => 0,
            'tapsell_native_banner_daily_cap' => 0,
            'free_story_ads_enabled' => true,
