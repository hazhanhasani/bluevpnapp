...
def main() -> None:
    ...
    require(version == "5.2.0", "this Windows migration must be release 5.2.0")
    ...
    # 5.2.0 Windows stability gates: Android UI parity, non-blocking media/metrics,
    ...
    # 5.2.0 CI/release hardening: installers must be root-level artifacts and
