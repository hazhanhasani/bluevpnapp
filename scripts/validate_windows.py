...
def main() -> None:
    ...
    require(version == "5.0.9", "this Windows migration must be release 5.0.9")
    ...
    # 5.0.9 Windows stability gates: Android UI parity, non-blocking media/metrics,
    ...
    # 5.0.9 CI/release hardening: installers must be root-level artifacts and
