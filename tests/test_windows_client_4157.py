...
class WindowsClient4162Tests(unittest.TestCase):
    def test_release_versions_are_unified(self):
        ...
        self.assertEqual(release["windows_version"], "4.17.3")
        self.assertEqual(release["windows_version_code"], 41703)
        self.assertEqual(branding["version_name"], "4.17.3")
        self.assertIn("<Version>4.17.3</Version>", text("bluevpn-windows/BlueVPN.Windows.csproj"))
