...
def test_release_is_502_and_codes_match():
    ...
    assert rel['version']=='5.7.10' and rel['version_code']==50709
    assert app['version_name']=='5.7.10' and app['version_code']==50709
    assert rel['windows_version']=='5.7.10' and rel['windows_version_code']==50709
