...
class StorePublishing523Tests(unittest.TestCase):
    def test_version_and_store_metadata(self):
        ...
        self.assertEqual((release["version"], release["version_code"]), ("5.2.3", 50203))
        self.assertEqual((app["version_name"], app["version_code"]), ("5.2.3", 50203))
    ...
    def test_play_manifest_and_tapsell_are_flavor_scoped(self):
        ...
        self.assertIn('fdroidImplementation("ir.tapsell:tapsell:', prepare)
