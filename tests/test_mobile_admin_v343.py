...
def test_release_version_343():
    ...
    assert release["version"] == "3.0.43"
    assert release["version_code"] == 30043
    assert app["version_name"] == "3.0.43"
    assert app["version_code"] == 30043
...
def test_mobile_styles_remove_desktop_mode_requirement():
    ...
    required = [
        "/* BlueVPN 3.0.43 — mobile-first responsive admin */",
