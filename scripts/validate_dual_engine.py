...
check("metadata-version-consistent", {app.get("version_name"), release.get("version"), marker.get("version_name"), marker.get("release")} == {"3.0.83"})
check("metadata-version-code-consistent", {app.get("version_code"), release.get("version_code"), marker.get("version_code")} == {30083})
