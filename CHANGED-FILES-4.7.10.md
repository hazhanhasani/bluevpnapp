...
- `branding/app.json` — 4.11.4 / 41104.
- `release.json` — 4.11.4 Fast CI release metadata.
- `bluevpn-manager/bluevpn-manager.php` — synchronized 4.11.4 version.
- `bluevpn-manager/readme.txt` — synchronized 4.11.4 changelog.
...
- `tests/test_sms_otp_autofill_477.py` / `tests/test_warp_adaptive_469.py` — current version contract updated to 4.11.4.
