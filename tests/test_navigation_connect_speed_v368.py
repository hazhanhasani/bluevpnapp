...
def test_release_368():
    ...
    assert r['version']=='3.0.79'
    assert r['version_code']==30079
    assert r['android_version']=='3.0.79'
    assert r['android_version_code']==30079
    assert a['version_name']=='3.0.79'
    assert a['version_code']==30079
