...
def main() -> None:
    ...
    require(version == "5.2.1", "this Windows migration must be release 5.2.1")
    ...
    # 5.2.1 Windows stability gates: Android UI parity, non-blocking media/metrics,
    ...
    # 5.2.1 CI/release hardening: installers must be root-level artifacts and
