...
مهم:
نسخه 4.0.21 مسیرهای عملیاتی اپ، تبلیغات، BlueAI، BluePay، Providerها، OTP و ربات را روی WordPress/MySQL در اختیار دارد. Railway فقط تا زمانی نگه داشته شود که Final Verify مهاجرت و تست End-to-End APK جدید سبز شوند؛ بعد از آن Backend اصلی می‌تواند WordPress باشد.
