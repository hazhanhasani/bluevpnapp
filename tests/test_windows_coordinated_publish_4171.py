...
class WindowsCoordinatedPublish4171Tests(unittest.TestCase):
    def test_release_version(self):
        ...
        self.assertEqual(release['version'],'4.17.10')
        self.assertEqual(release['version_code'],41710)
        self.assertEqual(release['windows_version'],'4.17.10')
        self.assertEqual(release['windows_version_code'],41710)
        self.assertEqual(branding['version_name'],'4.17.10')
        self.assertEqual(branding['version_code'],41710)
