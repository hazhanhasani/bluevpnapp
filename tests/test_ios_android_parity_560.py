...
class IOSAndroidParity560Tests(unittest.TestCase):
    ...
    def test_ios_targets_version_and_tunnel_contract(self):
        ...
        self.assertEqual(version['components']['ios'],'5.6.6')
        self.assertIn('MARKETING_VERSION: 5.6.6',project); self.assertIn('CURRENT_PROJECT_VERSION: 50606',project)
    ...
    def test_tunnel_is_ipv4_first_and_fail_closed(self):
        ...
        self.assertIn('runtimeNotEmbedded',tunnel); self.assertIn('completion(TunnelError.runtimeNotEmbedded)',tunnel)
