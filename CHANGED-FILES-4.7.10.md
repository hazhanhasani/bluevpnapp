...
- `branding/app.json` — 4.9.10 / 40910.
- `release.json` — 4.9.10 Fast CI release metadata.
- `bluevpn-manager/bluevpn-manager.php` — synchronized 4.9.10 version.
- `bluevpn-manager/readme.txt` — synchronized 4.9.10 changelog.
...
- `tests/test_sms_otp_autofill_477.py` / `tests/test_warp_adaptive_469.py` — current version contract updated to 4.9.10.
